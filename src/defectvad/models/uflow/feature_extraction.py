...
class CaitFeatureExtractor(nn.Module):
    ...
    def __init__(self) -> None:
        ...
        weight_path1 = get_backbone_path("cait_m48_448")
        state_dict1 = load_file(weight_path1)
        self.extractor1.load_state_dict(state_dict1)

        self.extractor2 = timm.create_model("cait_s24_224", pretrained=False)
        weight_path2 = get_backbone_path("cait_s24_224")
        state_dict2 = load_file(weight_path2)
        self.extractor2.load_state_dict(state_dict2)
