...
from defectvad.components.feature_extracotr import dryrun_find_featuremap_dims
...
class CfaModel(DynamicBufferMixin):
    ...
    def initialize_centroid(self, data_loader: DataLoader) -> None:
        ...
        with torch.no_grad():
            ...
            for i, data in enumerate(tqdm(data_loader, leave=False, desc=">> Initializing memory bank")):
